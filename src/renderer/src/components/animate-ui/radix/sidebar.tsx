...
import {
  ...
  SheetHeader,
  SheetTitle,
} from '@renderer/components/animate-ui/radix/sheet';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
  TooltipTrigger,
} from '@renderer/components/animate-ui/radix/tooltip';
import {
  MotionHighlight,
  MotionHighlightItem,
} from '@renderer/components/animate-ui/effects/motion-highlight';
...
function SidebarTrigger({ className, onClick, ...props }: SidebarTriggerProps): React.JSX.Element {
...
function SidebarRail({ className, ...props }: SidebarRailProps): React.JSX.Element {
  const { toggleSidebar } = useSidebar();
...
function SidebarInset({ className, ...props }: SidebarInsetProps): React.JSX.Element {
  return (
    <main
...
function SidebarInput({ className, ...props }: SidebarInputProps): React.JSX.Element {
  return (
    <Input
...
function SidebarHeader({ className, ...props }: SidebarHeaderProps): React.JSX.Element {
  return (
    <div
...
function SidebarFooter({ className, ...props }: SidebarFooterProps): React.JSX.Element {
  return (
    <div
...
function SidebarSeparator({ className, ...props }: SidebarSeparatorProps): React.JSX.Element {
  return (
    <Separator
...
function SidebarContent({ className, ...props }: SidebarContentProps): React.JSX.Element {
  return (
    <div
...
function SidebarGroup({ className, ...props }: SidebarGroupProps): React.JSX.Element {
  return (
    <div
...
function SidebarMenu({ className, ...props }: SidebarMenuProps): React.JSX.Element {
  return (
    <ul
...
function SidebarMenuItem({ className, ...props }: SidebarMenuItemProps): React.JSX.Element {
  return (
    <li
...
function SidebarMenuBadge({ className, ...props }: SidebarMenuBadgeProps): React.JSX.Element {
  return (
    <div
...
function SidebarMenuSub({ className, ...props }: SidebarMenuSubProps): React.JSX.Element {
  return (
    <ul
...
function SidebarMenuSubItem({ className, ...props }: SidebarMenuSubItemProps): React.JSX.Element {
  return (
    <li
