...
function Sheet({ children, ...props }: SheetProps): React.JSX.Element {
...
function SheetTitle({ className, ...props }: SheetTitleProps): React.JSX.Element {
  return (
...
function SheetDescription({ className, ...props }: SheetDescriptionProps): React.JSX.Element {
  return (
